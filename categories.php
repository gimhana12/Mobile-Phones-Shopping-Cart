...
<body>
    ...
    <header>
        ...
        <li type="none" type="none"><a href="about.php">About Us</a></li>
...
<section class="categories"  id="categories">
    <div class="heading">
        <h1>Browse Our Hottest<br>Categories</h1>
...
<!--box3-->
    <div class="box box3">
        <a href="apple Category.php"><img src="images/cate3.jpg" alt=" "></a>
        <h2>APPLE</h2>
        <span>30 items</span>
        <i class='bx bx-right-arrow-alt'></i>
    </div>
